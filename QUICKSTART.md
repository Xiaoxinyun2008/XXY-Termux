...
```
**说明：**
 - 会自动启动 [Termux:X11](https://github.com/termux/termux-x11/releases) 应用
 - 需要授权 Termux:X11 权限
- 首次启动可能需要等待 10-20 秒
...
4. 完成后关闭 [Termux:X11](https://github.com/termux/termux-x11/releases)
```
...
1. 查看日志文件
2. 记录错误信息
3. 在 GitHub 提交 Issue（https://github.com/Xiaoxinyun2008/XXY-Termux/issues/new/choose）
